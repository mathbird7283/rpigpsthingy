...
def visualize():
     from Lgraphics import GraphWin, Circle, Line, Point
     
     w=GraphWin("Graphical Representaiton",1000,1000)
     
     for i in database:
          x=Circle(Point(10*i[0],10*i[1]),4)
          x.setFill('blue')
          x.draw(w)
     ...
     for i in database:
          for j in database:
               ...
               if (i[0]==j[1]):
                    ...
                    continue
               print "Line darwn.",i,j
               l=Line(Point(10*i[0],10*i[1]),Point(10*j[0],10*j[1]))
               l.draw(w)
